...
function main()
    ...
    if tonumber(version) > tonumber(thisScript().version) then
        sampAddChatMessage('����� ���������� �� ������ %s, ����������� � /crb',version)
        upd = u
    end
    f:close()
...
-- anim.file PED,anim.name FALL_FALL[1130]
        for k,v in ipairs(lavki.lavki) do
            if v.text.text == '��������� �����!' then
                ...
                if z > 1 then
                    ...
                    renderFontDrawTextFromAlign(font,'��������� �����!',x,y,float4ToHex(lavki.colors['��������� �����']),2)
                end
                if v.buy and getDistanceBetweenCoords3d(MYPOS[1], MYPOS[2], MYPOS[3],v.pos[1],v.pos[2],MYPOS[3]) <= 1.5 and not lavki.coordmaster.work and not isCharPlayingAnim(PLAYER_PED,'FALL_FALL') then
                    if sampIsDialogActive() and sampGetDialogText():find('^%{%x+%}��������� ������ �����%: %{%x+%}%$%d+') then
                        wait(1)
        ...
        for IDTEXT = 0, 2048 do
            if sampIs3dTextDefined(IDTEXT) then
                ...
                for k,v in ipairs(lavki.lavki) do
                    ...
                    if d <= 1.9 and (text:find("^%w+_%w+ .+ �����$") or text:find('�����������')) then
                        v.text.id = IDTEXT
                        v.text.text = (text):gsub('%{%x+%}','')
                    elseif d <= 1.9 and v.text.id == IDTEXT and not (text:find("^%w+_%w+ .+ �����$") or text:find('�����������')) then
                        if v.buy and not lavki.coordmaster.work then
                            lavki.coordmaster.work = true
                            coordMaster(v.pos[1],v.pos[2],(posZ-2.1))
                        end
                        if v.render then 
                            sendTelegramMessage('�����(%s) ������������!',k)
                        end
                        v.text.text = '��������� �����!'
                        v.text.id = 0
                    end
        ...
        for id = 1,3000 do
            if sampTextdrawIsExists(id) then
                ...
                if (text == 'SHOP' or text == gameConvertText('�������','rustogame')) then
                ...
                if td.shop.pos[3] ~= 0 and
                    ...
                    text == gameConvertText('LD_S���:whit�','rustogame')
                    then
                    td.page = id
                end
                ...
                if bot.bool.v and lavkaOpen() and (text == gameConvertText('������','rustogame')) then
...
function imgui.OnDrawFrame()
   ...
   if window.v then
        ...
        imgui.Begin(u8'��������� ����� � ��',window,32+64)

        imgui.BeginChild('b1',imgui.ImVec2(150,100),true)
            local b = {
                {'telegram',u8'��������� ����������� � ��������',function() imgui.OpenPopup('tg') end},
                {'lavki',u8[[
����� ������ ���-����� ����� ��������� ��� ������
�������� ����� �� ������������ �����(�������� �� coordmaster'e)]],function() lavki.window.v = not lavki.window.v end},
                {'bot checker',u8[[��� ������� ��� ������ ������ �����(���� ��� ������� � ��� ������ �����������) � ���� ��������(�/�) �����(�)]],function() bot.window.v = not bot.window end},
            }
...
����� ��� ����� ������������ ������� � ����� (� ����� �����)
    ...
    if bot.window.v then
        ...
        if imgui.Checkbox(u8'��������� ����?',bot.bool) then
            bot.int = 1
            bot.td.int = 1
                        ...
                        if t.lavka then
                            if lavkaOpen() or sampIsDialogActive() then
                                ...
                                for IDTEXT = 0, 2048 do
                                    if sampIs3dTextDefined(IDTEXT) then
                                        local text, _, posX, posY, posZ, _, _, _, _ = sampGet3dTextInfoById(IDTEXT)
                                        if text:find('������') and getDistanceBetweenCoords3d(posX, posY, 0,MYPOS[1],MYPOS[2],0) <= 2.5 then
                                            selling = true
                                        end
                                    end
                                end
...
(���� ���������� ��������� ����� �� ������ � ���������)]])
        ...
        if imgui.Button(u8'�������� ������ ���������',imgui.ImVec2(350-35,30)) then
            imgui.OpenPopup('sure?')
        end
        imgui.TextQuestion(u8[[
������ ������ �������� 'https://arz-wiki.com/items/page/1+/' � ����� �������� �������
� ����� �������� 30 ���������
        ...
        if #bot.search.v > 1 then
            for k,v in ipairs(crItems) do
                ...
                if imgui.BeginPopupModal(u8(v),nil,64) then
                    ...
                    imgui.RadioButton(u8'������� �� ���� ����� � �����',int,0)
                    imgui.SameLine()
                    imgui.Text(string.rep(' ',(imgui.CalcTextSize(u8(v)).x/4) ))
                    imgui.RadioButton(u8'������ �����',int,1)
                    ...
                    if int.v == 1 then
                        ...
                        imgui.InputInt(u8'(���� �� ���� �����)##cost',bot.cost)
                        imgui.Text(u8'������� ������?')
                        imgui.SameLine()
...
������� �� github ����������� �������, ��� ������ ���� json ����([arz]CrBaron_Items.json) �� ����� ����������
�������� ���� json � ����� config]]):format(er),'<','>',0)
                else
                    ...
                    lua_thread.create(function()
                        ...
                        for page = 1,maxPage do
                            if isKeyDown(VK_0) then
                                sampShowDialog(1,'crBot',([[
    ������� ��� �������!
    ���� �������� %s ��������� �� %s/%s �������]]):format(#crItems,page,maxPage),'<','>',0)
                                break
                            end
                            local get = false
...
�� ���� ����� ������ � ������ ������� � ����� ��� ������ ����� �������� �����]])
        ...
        for k,v in pairs(lavki.lavki) do
            local r,g,b,a = unpack(j.lavki.colors['��������� �����'])
            imgui.SetCursorPos(imgui.ImVec2(v.imgui.x,v.imgui.y+40))
            if v.text.text:find('^%S+ ������ �����') then
                r,g,b,a = unpack(j.lavki.colors['������'])
            elseif v.text.text:find('^%S+ �������� �����') then
                r,g,b,a = unpack(j.lavki.colors['��������'])                
            elseif v.text.text:find('^%S+ ������ � �������� �����') then
                r,g,b,a = unpack(j.lavki.colors['������ � ��������'])                
            elseif v.text.text:find('^%S+ ����������� ������') then
            ...
            if imgui.IsItemHovered() then
                ...
                imgui.BeginTooltip()
                imgui.Text(u8('����� '..k..'\n'..v.text.text))
                imgui.Text(u8(v.render and '������ �������' or '������ ��������') ..u8'(���)')
                imgui.Text(u8(v.buy and '����� ��������' or '����� ���������') ..u8'(���)(����� ������������)')
                imgui.EndTooltip()
            end
...
function sampev.onShowDialog(id, style, title, b1, b2, text)
    if title == '{BFBBBA}' and text:find('^%{%x+%}��������� ������ �����%: %{%x+%}%$%d+') then

    end

    if bot.bool.v and lavkaOpen() and title:find('������� ��������') then
    -- if true then
        ...
        for l in text:gmatch('[^\n]+') do
            ...
            if l:find('^� �������%: (%d+) ��%.') and int == 0 then
                int = tonumber(l:match('^� �������%: (%d+) ��%.'))
            end
            if l:find('���������%: %$(%S+) �� (%d+) ��%.$') and cost == 0 then
                cost = ((l:match('���������%: %$(%S+) �� (%d+) ��%.$')):gsub('%.',''):gsub(',',''))
                cost = tonumber(cost)
            end
        end
        ...
        for k,v in ipairs(j.bot.items) do
            if v.item == item then
                if v.buy and v.cost <= cost then
                    ...
                    v.int = v.int - 1
                    sendTelegramMessage('������� %s ��� ������ �� %s$(�� 1��)\n����� ���� ������� %s ����������,�������� %s',item,cost,int,v.int)
                    if v.int == 0 then
